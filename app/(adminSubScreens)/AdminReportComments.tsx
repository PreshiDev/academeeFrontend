...
const UploadReportComment = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      const response = await api.post('/reportcomment/', formData, {
        headers: {
      ...
      Alert.alert('Success', 'Report Comment uploaded successfully');
      reset();
      setPdf(null);
      setPdfName('');
      setStatus('');
  ...
  return (
    <View style={styles.container}>
      <Appbar.Header>
        <Appbar.Content title="Upload Report Comment" />
      </Appbar.Header>

      <Card style={styles.card}>
        <Card.Title title="Upload Report Comment" />
        <Card.Content>
          <Controller
            control={control}
            name="title"
      ...
      >
        Report Commment uploaded successfully!
      </Snackbar>
    </View>
  );
};
...
export default UploadReportComment;
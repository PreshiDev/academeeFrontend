...
const UploadExamQueston = () => {
  ...
  useEffect(() => {
    const fetchChoices = async () => {
      try {
        const response = await api.get('/questionchoices/');
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      const response = await api.post('/examquestion/', formData, {
        headers: {
      ...
      Alert.alert('Success', 'Exam Question uploaded successfully');
      reset();
      setPdf(null);
      setPdfName('');
      setStatus('');
  ...
  return (
    <View style={styles.container}>
      <Appbar.Header>
        <Appbar.Content title="Upload Exam Questions" />
      </Appbar.Header>

      <Card style={styles.card}>
        <Card.Title title="Upload Exam Questions" />
        <Card.Content>
      ...
      >
        Exam Question uploaded successfully!
      </Snackbar>
    </View>
  );
};
...
export default UploadExamQueston;

...
const UploadWorkBook = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      const response = await api.post('/workbook/', formData, {
        headers: {
  ...
  return (
    <View style={styles.container}>
      <Appbar.Header>
        <Appbar.Content title="Upload Work Book" />
      </Appbar.Header>

      <Card style={styles.card}>
        <Card.Title title="Upload Work Book" />
        <Card.Content>
          <Controller
            control={control}
            name="title"
      ...
      >
        Work Book uploaded successfully!
      </Snackbar>
    </View>
  );
};

...
const UploadSchoolActivity = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      const response = await api.post('/schoolactivities/', formData, {
        headers: {
      ...
      Alert.alert('Success', 'School Activities uploaded successfully');
      reset();
      setPdf(null);
      setPdfName('');
      setStatus('');
  ...
  return (
    <View style={styles.container}>
      <Appbar.Header>
        <Appbar.Content title="Upload School Activities" />
      </Appbar.Header>

      <Card style={styles.card}>
        <Card.Title title="Upload School Activities" />
        <Card.Content>
          <Controller
            control={control}
            name="title"
      ...
      >
        School Activities uploaded successfully!
      </Snackbar>
    </View>
  );
};
...
export default UploadSchoolActivity;
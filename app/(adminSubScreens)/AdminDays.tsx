...
const UploadScheme = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      const response = await api.post('/schemework/', formData, {
        headers: {
      ...
      Alert.alert('Success', 'Scheme of work uploaded successfully');
      reset();
      setPdf(null);
      setPdfName('');
      setStatus('');
  ...
  return (
    <View style={styles.container}>
      <Appbar.Header>
        <Appbar.Content title="Upload Scheme Of Work" />
      </Appbar.Header>

      <Card style={styles.card}>
        <Card.Title title="Upload Scheme Of Work" />
        <Card.Content>
          <Controller
            control={control}
            name="title"

...
const UploadExamTimetable = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      const response = await api.post('/examtimetable/', formData, {
        headers: {
  ...
  return (
    <View style={styles.container}>
      <Appbar.Header>
        <Appbar.Content title="Upload School Calendar" />
      </Appbar.Header>

      <Card style={styles.card}>
        <Card.Title title="Upload School Calendar" />
        <Card.Content>
          <Controller
            control={control}
            name="title"
